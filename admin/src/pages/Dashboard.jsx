    ...
    return (
        <div className="flex flex-col h-full bg-gray-50">
            ...
            <div className="bg-blue-600 text-white text-[10px] py-0.5 px-4 text-center font-mono">
                SYSTEM_v1.3.1_ULTRASONIC | {new Date().toLocaleTimeString('tr-TR')}
            </div>
            {/* Top Stats */}
            ...
            <div className="flex flex-col lg:flex-row gap-6 h-[calc(100vh-220px)]">
                ...
                <div className="w-full lg:w-96 bg-white rounded-xl shadow-sm border border-gray-200 flex flex-col overflow-hidden">
                    <div className="p-4 border-b bg-gray-50 flex justify-between items-center">
                        ...
                        <span className="text-[10px] text-gray-400 font-mono">v1.3.1</span>
                    </div>
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="text-xs text-gray-500 flex flex-col gap-0.5">
                                        {(p.is_online === true || p.is_online === 1) ? (
                                            <div className="flex items-center gap-2">
                                                <span>🔋 %{p.battery_level || 100}</span>
                                                <span>•</span>
                                                <span>{Math.round(p.speed || 0)} km/s</span>
                                            </div>
                                        ) : (
                                            <span className="text-gray-400 italic font-medium">Çevrimdışı</span>
                                        )}
                                        {p.last_update && (
                                            <span className="text-[10px] text-gray-500">
                                                Son Veri: {new Date(p.last_update).toLocaleTimeString('tr-TR', { hour: '2-digit', minute: '2-digit', second: '2-digit' })}
                                            </span>
                                        )}
                                    </div>
                                </div>
